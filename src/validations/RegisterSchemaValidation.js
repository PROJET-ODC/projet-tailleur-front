...
const RegisterSchemaValidation = Yup.object().shape({
  ...
  role: Yup.string()
    ...
    .oneOf(["client", "tailleur", "vendeur"], "Rôle invalide"), // vous pouvez adapter les valeurs de rôle si nécessaire
  phone: Yup.string()
  ...
  //   picture: Yup.string().url("L'URL de l'image n'est pas valide").nullable(),
  bio: Yup.string()
